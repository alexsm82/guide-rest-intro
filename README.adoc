...
# This is a slightly modified version of the Open Liberty guide, showing how to add the WebSphere Migration Toolkit for Application Binaries to your build pipeline
